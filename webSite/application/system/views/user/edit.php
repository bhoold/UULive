		...
		<h2>用户 - 编辑</h2>
			...
			<?php echo form_open('', array('id'=>'form','class'=>'layui-form','lay-filter'=>'form')); ?>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="email" lay-verify="email" autocomplete="off" class="layui-input" value="<?php echo set_value('email', $user['email']); ?>">
					</div>
				</div>
        <div class="layui-form-item">
          <label class="layui-form-label">性别</label>
          <div class="layui-input-block">
            <input type="radio" name="sex" value="1" title="男" <?php echo set_checkbox('sex', '1', $user['sex']==='1'?TRUE:FALSE); ?>>
            <input type="radio" name="sex" value="0" title="女" <?php echo set_checkbox('sex', '0', $user['sex']==='0'?TRUE:FALSE); ?>>
						<input type="radio" name="sex" value="-1" title="保密" <?php echo set_checkbox('sex', '-1', $user['sex']==='-1'?TRUE:FALSE); ?>>
          </div>
        </div>
        <div class="layui-form-item">
