			...
			<?php echo form_open('', array('id'=>'form','class'=>'layui-form','lay-filter'=>'form')); ?>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="username" required  lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo set_value('username'); ?>">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">密码</label>
					<div class="layui-input-inline">
						<input type="password" name="password" required lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo set_value('password', '123456'); ?>">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" name="email" lay-verify="email" autocomplete="off" class="layui-input" value="<?php echo set_value('email'); ?>">
					</div>
				</div>
        <div class="layui-form-item">
          <label class="layui-form-label">性别</label>
          <div class="layui-input-block">
            <input type="radio" name="sex" value="1" title="男" <?php echo set_checkbox('sex', '1'); ?>>
            <input type="radio" name="sex" value="0" title="女" <?php echo set_checkbox('sex', '0'); ?>>
						<input type="radio" name="sex" value="-1" title="保密" <?php echo set_checkbox('sex', '-1', TRUE); ?>>
          </div>
        </div>
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
            ...
            <input type="checkbox" name="state" lay-skin="switch" lay-text="启用|停用" value="1" <?php echo set_checkbox('state', '1', TRUE); ?>>
          </div>
        </div>
