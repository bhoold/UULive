  ...
  <div class="layui-body">
    ...
    <div id="body-container">
		...
		<div class="toolbar layui-btn-container">
			...
			<button type="button" class="layui-btn layui-btn-primary" data-type="edit">编辑</button>
			<button type="button" class="layui-btn layui-btn-primary" data-type="block">停用</button>
			<button type="button" class="layui-btn layui-btn-primary" data-type="unblock">启用</button>
    ...
    <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layadmin-useradmin-formlist">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-inline">
          ...
          <div class="layui-input-block">
            <input type="text" name="filter[email]" placeholder="" autocomplete="off" class="layui-input" value="<?php echo $filter['email'];?>">
          </div>
        </div>
        <div class="layui-inline">
