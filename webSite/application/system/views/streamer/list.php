  ...
  <div class="layui-body">
    ...
    <div id="body-container">
		...
		<div class="toolbar layui-btn-container">
			<button type="button" class="layui-btn layui-btn-primary" data-type="unblock">审核通过</button>
			<button type="button" class="layui-btn layui-btn-primary" data-type="block">审核拒绝</button>
		</div>
    ...
    <table class="layui-hide" id="listTable" lay-filter="listTable">
      <thead>
        <tr>
          ...
          <th lay-data="{field:'userid', width:80}">账号ID</th>
          ...
          <th lay-data="{field:'idcardpic1', width:150}">身份证正面</th>
          <th lay-data="{field:'idcardpic2', width:150}">身份证反面</th>
					<!--
      ...
      <tbody>
				...
				<tr>
					...
					<td><?php echo $item['state'] === '-1' ? '未审核' : ($item['state'] === '1' ? '审核通过' : '审核拒绝');?></td>
					<td><?php echo $item['regtime'];?></td>
					<td><?php echo $item['regip'];?></td>
					<td><a target="_blank" href="<?php echo base_url().$item['idcardpic1'];?>">查看</a></td>
					<td><a target="_blank" href="<?php echo base_url().$item['idcardpic2'];?>">查看</a></td>
					<td></td>
        </tr>
				<?php endforeach;?>
      </tbody>
